...
?>
	...
	<img src="search5.png" class="userimage" height="120px" width="120px" align="left"><h2>SEARCH AMOUNT</h2>

	<form action="searchresult.php" method="post">
	<BR><BR>

	<!-- 1.Item    2.Category    3.Price    4.EntryDate  -->
	<input type="hidden" name="searchby" value="3">
	
	<input type="text" name="searchvalue" placeholder="Enter PaidAmount" required="" 
