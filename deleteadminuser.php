...
<div class="box" style="height: 400px; transform: translate(-45%,-45%); ">
	<BR><BR>
	<img src="delete.png" class="userimage" height="70px" width="70px" align="left"><h2>Delete Admin USER</h2>

	<form action="deleteuser.php" method="post">
		<h3 style="color:#aaa; letter-spacing: .2em;">Exisiting Admin Users:</h3> 
