...
?>
	...
	<img src="search5.png" class="userimage" height="120px" width="120px" align="left"><h2>SEARCH ITEM</h2>
	...
	<input type="text" name="searchvalue" placeholder="Enter Item Name" required="" 
