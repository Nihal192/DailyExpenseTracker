...
<img src="yearly.png" class="userimage" height="150px" width="150px" align="left" style="margin-left:60px;">
<BR><h2>YEARLY REPORT</h2>

<form action="showrepyearly.php" method="post">
